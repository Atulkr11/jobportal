...
try {
	...
	if ($jobtype == "Part-time Internship") {
	$sta = '<span class="label label-danger">Part-time Internship</span>';
											  
	}
	if ($jobtype == "Full-time Internship") {
	$sta = '<span class="label label-warning">Full-time Internship</span>';
...
<head>
	...
	<title>Internship Management Portal - <?php echo "$jobtitle"; ?></title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
						<a href="./"><p>Internship Management Portal<p></a>
						</div>
					</div>
