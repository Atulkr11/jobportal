...
<head>
	...
	<title>Internship Management Portal - Contact Us</title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><p>Internship Management Portal Portal<p></a>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Delhi G.T Road, <br/> Phagwara, <br/>Punjab, India</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:atulcpr123@gmail.com">atulcpr123@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:06152-22321">06152-22222</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Internship Management Portal</h5>
											<p>Internship Portal is an online internship management system developed by Atul Kumar & Abhinav Kumar for his project in October 2022.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Internship Management Portal Contact</h5>
								
								<p>Address : Delhi GT Road, Phagwara, Punjab, India</p>
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">atulcpr123@gmail.com</a></p>
								<p>Phone : <a href="tel:+233546607474">06152-22222</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Internship Management Portal Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Atul Kumar & Abhinav Kumar</a></li>
								</ul>
